...
export const trails: Trail[] = [
  ...
  },
  {
    ...
    requiresReservation: true,
    description: {
      en: "The traverse begins at the Circuito Chico crossing with the López stream, where a steep but relatively short ascent of less than 5 km begins to Refugio López. Along the way, you pass the Refugio Roca Negra before reaching the refuge after approximately 1 hour and 40 minutes. From there, it is necessary to register to continue to Pico Turista or Laguna Negra.\n\nThe ascent continues along the López wall to the edge, in a demanding and rocky section that takes more than an hour. It is a vertical path where you advance between stones, so it is essential to have good footwear and physical condition. Once the pass is reached, a panoramic view opens to the west, where you can see the Tronador, Osorno, Puntiagudo, Capilla and the Tristeza Arm of Lake Nahuel Huapi. From there, the path descends abruptly through loose scree, this being the most technical section of the route. The descent must be done with caution, as the stones can move and cause falls. After 40 minutes, more stable terrain is reached in the valley.\n\nAfter descending, the trail crosses a forest of lengas and wetlands, where a rustic camping used to exist but was prohibited for environmental reasons. Next, a new ascent begins to the col of Cerro Bailey Willis, where you once again get a view of Tronador and Laguna CAB. Going to the right, the mountain is traversed among large rocks to a second col, where you get the first view of Laguna Negra.\n\nThe trail continues along the edge before beginning the descent to the lagoon. The lagoon is bordered on the left margin, crossing rocky sectors with the help of chains and ropes installed to facilitate passage. Depending on the time of year, it is possible to find snow patches on this section. Once on the opposite shore, with Refugio Italia on the right, the final descent begins along the El Caracol trail, which descends in a zigzag towards the valley.\n\nAfter crossing the river, the path becomes flatter and the descent more gradual. This last section is completed more quickly and ends on the old road to Colonia Suiza, thus completing the traverse.",
      ...
      fr: "La traversée commence au croisement du Circuito Chico avec le ruisseau López, où commence une montée raide mais relativement courte de moins de 5 km jusqu'au Refugio López. En chemin, on passe par le Refugio Roca Negra avant d'arriver, après environ 1 heure et 40 minutes, au refuge. De là, il est nécessaire de s'inscrire pour continuer vers Pico Turista ou Laguna Negra.\n\nL'ascension continue le long du mur de López jusqu'au bord, dans une section exigeante et rocheuse qui prend plus d'une heure. C'est un sentier vertical où l'on avance entre les pierres, il est donc essentiel d'avoir de bonnes chaussures et une bonne condition physique. Une fois le col atteint, une vue panoramique s'ouvre à l'ouest, où l'on peut voir le Tronador, l'Osorno, le Puntiagudo, le Capilla et le bras Tristeza du lac Nahuel Huapi. De là, le sentier descend brusquement à travers des éboulis, c'est la section la plus technique de l'itinéraire. La descente doit se faire avec prudence, car les pierres peuvent se déplacer et provoquer des chutes. Après 40 minutes, on atteint un terrain plus stable dans la vallée.\n\nAprès la descente, le sentier traverse une forêt de lengas et de zones humides, où existait autrefois un camping rustique qui a été interdit pour des raisons environnementales. Ensuite, une nouvelle ascension commence jusqu'au col du Cerro Bailey Willis, où l'on obtient à nouveau une vue sur le Tronador et la Laguna CAB. En allant à droite, la montagne est traversée parmi de grandes roches jusqu'à un deuxième col, où l'on a la première vue de la Laguna Negra.\n\nLe sentier continue le long du bord avant de commencer la descente vers le lagon. Le lagon est bordé sur la marge gauche, traversant des secteurs rocheux à l'aide de chaînes et de cordes installées pour faciliter le passage. Selon la période de l'année, il est possible de trouver des plaques de neige sur cette section. Une fois sur la rive opposée, avec le Refugio Italia sur la droite, la descente finale commence le long du sentier El Caracol, qui descend en zigzag vers la vallée.\n\nAprès avoir traversé la rivière, le chemin devient plus plat et le descenso plus progressive. Cette dernière section se termine plus rapidement et se termine sur l'ancienne route de Colonia Suiza, complétant ainsi la traversée.",
      de: "Die Überquerung beginnt an der Kreuzung des Circuito Chico mit dem López-Bach, wo ein steiler, aber relativ kurzer Aufstieg von weniger als 5 km zum Refugio López beginnt. Auf dem Weg passiert man das Refugio Roca Negra, bevor man nach etwa 1 Stunde und 40 Minuten die Schutzhütte erreicht. Von dort aus muss man sich registrieren, um zum Pico Turista oder zur Laguna Negra weiterzugehen.\n\nDer Aufstieg führt weiter entlang der López-Wand bis zur Kante, in einem anspruchsvollen und felsigen Abschnitt, der mehr als eine Stunde dauert. Es ist ein vertikaler Pfad, auf dem man zwischen Steinen vorankommt, daher ist es wichtig, gutes Schuhwerk und eine gute körperliche Verfassung zu haben. Sobald der Pass erreicht ist, öffnet sich ein Panoramablick nach Westen, wo man den Tronador, den Osorno, den Puntiagudo, den Capilla und den Tristeza-Arm des Nahuel Huapi-Sees sehen kann. Von dort aus führt der Weg abrupt durch loses Geröll hinab, dies ist der technisch anspruchsvollste Abschnitt der Route. Der Abstieg muss mit Vorsicht erfolgen, da sich die Steine bewegen und Stürze verursachen können. Nach 40 Minuten erreicht man stabileres Gelände im Tal.\n\nNach dem Abstieg überquert der Weg einen Wald aus Lengas und Feuchtgebieten, wo früher ein rustikaler Campingplatz existierte, der aus Umweltgründen verboten wurde. Anschließend beginnt ein neuer Aufstieg zum Sattel des Cerro Bailey Willis, wo man erneut einen Blick auf den Tronador und die Laguna CAB erhält. Nach rechts gehend, wird der Berg zwischen großen Felsen bis zu einem zweiten Sattel durchquert, wo man den ersten Blick auf die Laguna Negra hat.\n\nDer Weg führt weiter entlang der Kante, bevor der Abstieg zur Lagune beginnt. Die Lagune wird am linken Rand umgangen, wobei felsige Abschnitte mit Hilfe von Ketten und Seilen überquert werden, die den Durchgang erleichtern. Je nach Jahreszeit ist es möglich, in diesem Abschnitt Schneefelder zu finden. Auf der gegenüberliegenden Seite, mit dem Refugio Italia auf der rechten Seite, beginnt der endgültige Abstieg entlang des El Caracol-Pfades, der im Zickzack ins Tal hinabführt.\n\nNach Überquerung des Flusses wird der Weg flacher und der Abstieg allmählicher. Dieser letzte Abschnitt wird schneller abgeschlossen und endet auf der alten Straße nach Colonia Suiza, womit die Überquerung abgeschlossen ist."
    },
    imageUrl: "/lovable-uploads/a210f1ff-a5c5-4288-a37a-33d461911db7.png",
    startingPoint: "La Panchería in Circuito Chico (45 min by bus from Los Coihues)",
    highlights: ["highlightPanoramicViews", "highlightMountainRefuge", "highlightAlpineLakes", "highlightHighMountainPasses"],
    transportation: ["bus", "taxi"],
    distanceFromCampsite: 18,
    travelTime: 45,
    busLines: "Linea 50 (los Coihues) + Linea 10 (desde Av. Bustillo km 8) hasta la Panchería del Circuito Chico (45 min)",
